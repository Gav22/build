...
#########
#Error message for the building of Realtek 8188EU 8188EUS and 8188ETV chipsets
#drivers/net/wireless/rtl8188eu/os_dep/linux/ioctl_cfg80211.c:10276:2: error: #endif without #if
#10276 | #endif /* CONFIG_IOCTL_CFG80211 */
#      |  ^~~~~
#make[4]: *** [scripts/Makefile.build:281: drivers/net/wireless/rtl8188eu/os_dep/linux/ioctl_cfg80211.o] Error 1
#make[4]: *** Waiting for unfinished jobs....
#make[3]: *** [scripts/Makefile.build:497: drivers/net/wireless/rtl8188eu] Error 2
